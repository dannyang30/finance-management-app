...
app.get('/get-transaction', (request, response) => {
    const q = "SELECT * FROM transactions WHERE `session_id` = '2a'";
...
app.put('/update-transaction', (request, response) => {
    ...
    const values = [ parsedAmount, transaction_type, transaction_category, transaction_date, transaction_id ];
...
app.delete('/delete-transaction', (request, response) => {
    const q = 'DELETE FROM transactions WHERE transaction_id = "2"';
